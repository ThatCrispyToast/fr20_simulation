...
# Which sim wrote a run -- tags the output folder (run_<SIM_TAG>_<timestamp>). "point" =
# this original point model; siblings: "packet" (bin_reach.py), "packed" (bin_reach_packed.py).
SIM_TAG   = "point"
