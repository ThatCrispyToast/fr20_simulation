...
# Which sim wrote a run -- tags the output folder (run_<SIM_TAG>_<timestamp>) so the
# three variants' runs are distinguishable on disk. "packet" = this fine packet grid;
# the siblings use "point" (bin_reach_points.py) and "packed" (bin_reach_packed.py).
SIM_TAG   = "packet"
